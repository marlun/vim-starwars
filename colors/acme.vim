...
hi Normal guifg=#444444 guibg=#FFFDF7 gui=NONE ctermfg=235 ctermbg=230 cterm=NONE
hi Boolean guifg=#2aa198 guibg=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=bold
hi Comment guifg=#cb4b16 guibg=NONE gui=italic ctermfg=235 ctermbg=NONE cterm=italic
hi Constant guifg=#009900 guibg=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=italic
...
hi Number guifg=#C71585 guibg=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=bold
hi PreProc guifg=#875FFF guibg=NONE gui=NONE ctermfg=130 ctermbg=NONE cterm=NONE
hi Special guifg=#cb4b16 guibg=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=bold
hi Statement guifg=#025ffd guibg=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=bold
...
hi link jsParens Type
hi link jsFuncParens Type
hi link jsFuncBraces Type
